...
def get_BLS_county_data(BLS_data_path, df_areas):
    ...
    df_bls_county = pd.read_csv(BLS_data_path, dtype = col_types, delimiter= '\t')
    print("cols")
    print(df_bls_county.columns)
...
df_unemp_county = df_unemp_15_19
